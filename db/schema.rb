...
ActiveRecord::Schema.define(version: 20160912120146) do
  ...
  create_table "user_details", force: :cascade do |t|
    ...
    t.string   "last_name",       limit: 255,   default: "Ajwelkar", null: false
    t.integer  "gender",          limit: 1
    t.string   "secondary_title", limit: 255
    t.string   "display_pic_url", limit: 255
    t.string   "cover_pic_url",   limit: 255
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at",                                      null: false
    t.datetime "updated_at",                                      null: false
    t.integer  "profile_status",         limit: 1,   default: 1,  null: false
  end
